...
// Infer MenuTextMatch from useBasicTypeaheadTriggerMatch return type
type MenuTextMatch = NonNullable<ReturnType<ReturnType<typeof useBasicTypeaheadTriggerMatch>>>
...
const LexicalTypeaheadMenuPlugin = lazy(
  () =>
    import("@lexical/react/LexicalTypeaheadMenuPlugin").then(
      (mod) => ({ default: mod.LexicalTypeaheadMenuPlugin<MentionTypeaheadOption> })
    )
)
