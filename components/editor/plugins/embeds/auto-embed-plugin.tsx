...
// Infer EmbedConfig from LexicalAutoEmbedPlugin's embedConfigs prop type
type LexicalAutoEmbedPluginProps = ComponentProps<typeof LexicalAutoEmbedPlugin<any>>
type EmbedConfig = NonNullable<LexicalAutoEmbedPluginProps["embedConfigs"]>[number]

// Infer EmbedMatchResult from EmbedConfig's parseUrl return type
type EmbedMatchResult = Awaited<ReturnType<NonNullable<EmbedConfig["parseUrl"]>>>
