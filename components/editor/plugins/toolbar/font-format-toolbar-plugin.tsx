...
// Infer BaseSelection from $getSelection return type
type BaseSelection = NonNullable<ReturnType<typeof $getSelection>>
// Define TextFormatType as union type based on usage
type TextFormatType = "bold" | "italic" | "underline" | "strikethrough" | "code" | "subscript" | "superscript"
import {
  BoldIcon,
  ItalicIcon,
  StrikethroughIcon,
